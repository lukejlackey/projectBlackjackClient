...
const Dash = () => {
    ...
    useEffect(() => {
        ...
        axios.post(`http://127.0.0.1:5000/update`, {
            user_id : localStorage.getItem('p_id'),
    ...
    return (
        <div>
            ...
            <form className="generalFlex flexCol w-80 gap-1" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="screen-gold redBtn">Play Game</button>
            </form>
            <div className="container-gold" id="stats">
                ...
                <div className="generalFlex">
                    ...
                    <div className="w-25">
                        ...
                        <p className="greenText text-center" id="wl_ratio">{localStorage.getItem('wins')}</p>
